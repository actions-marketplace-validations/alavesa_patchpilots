...
export function registerDesignerCommand(program: Command): void {
  program
    .command("designer <path>")
    .description("Run a design and accessibility audit on source files")
    ...
    .action(async (targetPath: string, opts) => {
      try {
        ...
        await orchestrator.designAudit(targetPath, {
          json: opts.json,
